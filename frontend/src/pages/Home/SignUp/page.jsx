...
function App() {
	...
	return (
	<>
		<div className='w-screen h-screen mt-12 border-grey-300 pt-4 bg-pink-50 flex items-center justify-center crimson'>
			<div className='w-[90%] h sm:max-w-[500px] md:max-w-[800px] h-auto bg-white rounded-2xl flex flex-row overflow-hidden shadow-[0_0_10px_rgba(0,0,0,0.1)]'>
